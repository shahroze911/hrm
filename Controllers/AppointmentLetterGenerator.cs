...
public class AppointmentLetterGenerator
{
    public string GenerateAppointmentLetter(Employee employee)
    {
        // Define the path to the template and the output file
        string templatePath = HttpContext.Current.Server.MapPath("~/Documents/appointment_letter.docx");
        ...
        try
        {
            ...
            using (DocX document = DocX.Load(templatePath))
            {
                ...
                document.ReplaceText("[Designation]", employee.Designation);
                ...
                document.ReplaceText("[Date]", DateTime.Now.ToString("dd MMMM yyyy"));
